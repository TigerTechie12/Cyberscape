...
export type GetSpaceElementsAggregateType<T extends SpaceElementsAggregateArgs> = {
    [P in keyof T & keyof AggregateSpaceElements]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateSpaceElements[P]> : Prisma.GetScalarType<T[P], AggregateSpaceElements[P]>;
};
...
type GetSpaceElementsGroupByPayload<T extends spaceElementsGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<SpaceElementsGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof SpaceElementsGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], SpaceElementsGroupByOutputType[P]> : Prisma.GetScalarType<T[P], SpaceElementsGroupByOutputType[P]>;
}>>;
...
export type spaceElementsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<spaceElementsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface spaceElementsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['spaceElements'];
        meta: {
            name: 'spaceElements';
        };
    };
     ...
     * })
    **/
    count<T extends spaceElementsCountArgs>(args?: Prisma.Subset<T, spaceElementsCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], SpaceElementsCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends spaceElementsGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, spaceElementsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSpaceElementsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export {};
//# sourceMappingURL=spaceElements.d.ts.map